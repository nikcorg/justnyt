...
class CandidateTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('CandidateId', 'CreatedOn', 'InvitedOn', 'Email', ),
        self::TYPE_STUDLYPHPNAME => array('candidateId', 'createdOn', 'invitedOn', 'email', ),
        self::TYPE_COLNAME       => array(CandidateTableMap::COL_CANDIDATE_ID, CandidateTableMap::COL_CREATED_ON, CandidateTableMap::COL_INVITED_ON, CandidateTableMap::COL_EMAIL, ),
        self::TYPE_RAW_COLNAME   => array('COL_CANDIDATE_ID', 'COL_CREATED_ON', 'COL_INVITED_ON', 'COL_EMAIL', ),
        self::TYPE_FIELDNAME     => array('candidate_id', 'created_on', 'invited_on', 'email', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('CandidateId' => 0, 'CreatedOn' => 1, 'InvitedOn' => 2, 'Email' => 3, ),
        self::TYPE_STUDLYPHPNAME => array('candidateId' => 0, 'createdOn' => 1, 'invitedOn' => 2, 'email' => 3, ),
        self::TYPE_COLNAME       => array(CandidateTableMap::COL_CANDIDATE_ID => 0, CandidateTableMap::COL_CREATED_ON => 1, CandidateTableMap::COL_INVITED_ON => 2, CandidateTableMap::COL_EMAIL => 3, ),
        self::TYPE_RAW_COLNAME   => array('COL_CANDIDATE_ID' => 0, 'COL_CREATED_ON' => 1, 'COL_INVITED_ON' => 2, 'COL_EMAIL' => 3, ),
        self::TYPE_FIELDNAME     => array('candidate_id' => 0, 'created_on' => 1, 'invited_on' => 2, 'email' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
